    ...
    <>
      <style jsx global>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .bot-card:hover { border-color: rgba(121,34,242,0.25); transform: translateY(-3px); }
        .bot-card:hover::before { opacity: 1; }

        .bot-card-top { display: flex; align-items: center; gap: 18px; margin-bottom: 26px; }

        .bot-avatar { position: relative; flex-shrink: 0; }

        .bot-avatar img, .bot-avatar-fallback {
        ...
        .bot-status-dot.online { background: #57f287; box-shadow: 0 0 8px rgba(87,242,135,0.7); }
        .bot-status-dot.offline { background: #4e4e4e; }
        ...
        .bot-status-label { font-family: 'JetBrains Mono', monospace; font-size: 10px; letter-spacing: 0.08em; }
        ...
        .bot-actions { display: flex; gap: 12px; }
        ...
        .btn-remove {
          min-height: 48px; padding: 12px 15px; border-radius: 16px;
          font-size: 13px; font-weight: 800;
        ...
        .btn-remove:hover { background: rgba(248,113,113,0.16); transform: translateY(-1px); }
        ...
        .bot-card-add {
          ...
          min-height: 218px; cursor: pointer;
        ...
        .add-icon {
          ...
          background: rgba(121,34,242,0.12); border: 1px solid rgba(121,34,242,0.2);
          font-size: 26px; color: #b47cff; line-height: 1;
        }

        .add-label { font-size: 14px; font-weight: 700; color: rgba(255,255,255,0.42); }

        .empty-card {
          width: 100%; max-width: 680px; margin-top: 10px;
          background: rgba(255,255,255,0.025);
          border: 1px solid rgba(255,255,255,0.07);
          border-radius: 32px; padding: 68px 40px;
        ...
        .empty-icon {
          ...
          display: flex; align-items: center; justify-content: center;
          border-radius: 999px;
          background: rgba(121,34,242,0.15); border: 1px solid rgba(121,34,242,0.2);
          font-size: 34px;
        }
        ...
        .btn-connect {
          ...
          padding: 15px 30px; border-radius: 17px;
        ...
        .modal-title { font-size: 22px; font-weight: 800; letter-spacing: -0.04em; margin-bottom: 6px; }
        ...
        .modal-sub span { color: #95fe59; font-family: 'JetBrains Mono', monospace; }

        .modal-label { display: block; font-size: 12px; font-weight: 700; color: rgba(255,255,255,0.5); margin-bottom: 8px; }
        ...
        .modal-input:focus {
          outline: none; border-color: #7922f2;
        ...
        @media (max-width: 640px) {
          .dash-header { padding: 24px 18px 0; }
          .dash-logo { height: 40px; }
          .section-wrap { padding: 42px 18px 64px; }
          .section-header { margin-bottom: 34px; }
          .section-title { font-size: 28px; }
          .section-subtitle { font-size: 13px; }
          .bots-grid { grid-template-columns: 1fr; max-width: 400px; gap: 20px; }
          .bot-card { padding: 24px; border-radius: 24px; }
        ...
        >
          <div className="modal-box">
            ...
            <p className="modal-sub">
              ...
              O bot precisa estar online para conectar.
            </p>
            ...
            <p className="modal-hint">O código expira em 5 minutos após gerado.</p>
